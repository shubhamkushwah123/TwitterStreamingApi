...
public class TwitterAuthenticator {
     ...
     * @throws IOException 
     */
    public synchronized HttpRequestFactory getAuthorizedHttpRequestFactory() throws TwitterAuthenticationException, IOException {
        if (factory != null) {
            return factory;
        }
     ...
     * @throws IOException 
     */
    private HttpRequestFactory createRequestFactory() throws TwitterAuthenticationException, IOException {
     ...
     * @throws IOException 
     */
    private String retrievePin(final OAuthAuthorizeTemporaryTokenUrl authorizeUrl) throws TwitterAuthenticationException, IOException {
        String providedPin;
    ...
    private OAuthCredentialsResponse retrieveAccessTokens(final String providedPin, final OAuthHmacSigner signer, final String token) throws TwitterAuthenticationException {
        ...
        out.println("Please copy & paste the access token & secret token into twitter4j.properties file if not there already");
        out.println("Access Token : " + accessTokenResponse.token);
        out.println("Token secret : " + accessTokenResponse.tokenSecret);
